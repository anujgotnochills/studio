...
void main() {
  ...
  gl_FragColor  = color;
      ...
      const loop = (t: number) => {
        ...
        // Calculate time accounting for paused periods
      ...
      visibilityObserverRef.current = new IntersectionObserver(
        ...
        },
        {
          ...
          rootMargin: "100px", // Keep running when within 100px
        }
      );
      ...
      if (
        containerRef.current?.parentElement &&
        visibilityObserverRef.current
      ) {
        visibilityObserverRef.current.observe(
          containerRef.current.parentElement
        );
      }
