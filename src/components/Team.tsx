...
export default function Team() {
  ...
  return (
    <section 
      ref={sectionRef} 
      className="relative w-full min-h-[auto] md:min-h-screen bg-transparent pt-10 pb-6 md:pt-16 md:pb-12 flex flex-col items-center overflow-visible md:overflow-hidden z-10 box-border"
    >
